...
abstract class BaseRecurso extends BaseObject implements Persistent
{
    ...
    public function setResId($v)
    {
        ...
        if ($this->res_id !== $v) {
            $this->res_id = $v;
            $this->modifiedColumns[] = RecursoPeer::RES_ID;
        }
    ...
    public function setUsuId($v)
    {
        ...
        if ($this->usu_id !== $v) {
            $this->usu_id = $v;
            $this->modifiedColumns[] = RecursoPeer::USU_ID;
        }
    ...
    public function setPlaId($v)
    {
        ...
        if ($this->pla_id !== $v) {
            $this->pla_id = $v;
            $this->modifiedColumns[] = RecursoPeer::PLA_ID;
        }
    ...
    /**
     * Sets the value of the [rec_eliminado] column.
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->pla_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->rec_src = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->rec_estado = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
            $this->rec_eliminado = ($row[$startcol + 6] !== null) ? (boolean) $row[$startcol + 6] : null;
            ...
            return $startcol + 9; // 9 = RecursoPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RecursoPeer::RES_ID)) {
            $modifiedColumns[':p' . $index++]  = '`res_id`';
        }
        if ($this->isColumnModified(RecursoPeer::USU_ID)) {
            $modifiedColumns[':p' . $index++]  = '`usu_id`';
        }
        if ($this->isColumnModified(RecursoPeer::PLA_ID)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`rec_estado`':
                        ...
                        break;
                    case '`rec_eliminado`':
                        $stmt->bindValue($identifier, (int) $this->rec_eliminado, PDO::PARAM_INT);
                        break;
                    case '`created_at`':
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[3] => $this->getPlaId(),
            $keys[4] => $this->getRecSrc(),
            $keys[5] => $this->getRecEstado(),
            $keys[6] => $this->getRecEliminado(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setPlaId($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setRecSrc($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setRecEstado($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setRecEliminado($arr[$keys[6]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RecursoPeer::RES_ID)) $criteria->add(RecursoPeer::RES_ID, $this->res_id);
        if ($this->isColumnModified(RecursoPeer::USU_ID)) $criteria->add(RecursoPeer::USU_ID, $this->usu_id);
        if ($this->isColumnModified(RecursoPeer::PLA_ID)) $criteria->add(RecursoPeer::PLA_ID, $this->pla_id);
    ...
    public function getResturant(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aResturant === null && ($this->res_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aResturant->addRecursos($this);
             */
        }
    ...
    public function getUsuario(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUsuario === null && ($this->usu_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUsuario->addRecursos($this);
             */
        }
